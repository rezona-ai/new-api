...
export const channelFormSchema = z
  .object({
    ...
    disable_local_token_billing: z.boolean().optional(),
...
export const CHANNEL_FORM_DEFAULT_VALUES: ChannelFormValues = {
  ...
  disable_local_token_billing: false,
  ...
  if (channel.setting) {
    try {
      ...
      extraSettings = {
        ...
        disable_local_token_billing:
          parsed.disable_local_token_billing || false,
      }
    } catch (error) {
...
function buildSettingJSON(formData: ChannelFormValues): string {
  const settingObj = {
    ...
    disable_local_token_billing: formData.disable_local_token_billing || false,
  }
