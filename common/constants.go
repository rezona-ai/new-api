...
// Only "default" is supported now that the classic frontend has been removed.
// Any other value (including legacy "classic" persisted by older deployments)
// is silently ignored, leaving the theme at "default".
...
// ThemeAwarePath rewrites legacy /console/* paths to their default-theme
